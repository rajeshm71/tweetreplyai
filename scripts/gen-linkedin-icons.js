/**
 * Generates placeholder PNG icons for the LinkedIn extension.
 * Uses only Node built-in modules. LinkedIn blue: #0a66c2 (R=10, G=102, B=194).
 */
import fs from 'fs';
...
const OUT_DIR = path.join(__dirname, '..', 'extension-linkedin', 'icons');

// LinkedIn brand blue
const R = 10, G = 102, B = 194;
